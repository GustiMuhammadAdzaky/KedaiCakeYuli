...
object KueData {
    private val kueNames = arrayListOf("Ahmad Dahlan",
        "Ahmad Yani",
        "Sutomo",
        "Gatot Soebroto",
    ...
    private val kueDetails = arrayListOf("Salah seorang ulama dan khatib terkemuka di Masjid Besar Kasultanan Yogyakarta pada masa itu, dan ibu dari K.H. Ahmad Dahlan adalah puteri dari H. Ibrahim yang juga menjabat penghulu Kesultanan Ngayogyakarta Hadiningrat pada masa itu. KH. Ahmad Dahlan telah mempelopori kebangkitan ummat Islam untuk menyadari nasibnya sebagai bangsa terjajah yang masih harus belajar dan berbuat.",
    ...
    private val kueImages = arrayListOf(R.drawable.ahmad_dahlan,
    ...
    val getData: MutableList<Kue>
        get() {
            val data = mutableListOf<Kue>()
            for (position in kueNames.indices){
                val kue = Kue()
                kue.let {
                    it.name = kueNames[position]
                    it.detail = kueDetails[position]
                    it.photo = kueImages[position]
                }
                data.add(kue)
            }
            return data
